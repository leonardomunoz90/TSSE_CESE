...
int main(void)
{
  ...
  run_test(test_preder_y_apagar_un_led, "test_preder_y_apagar_un_led", 40);
  run_test(test_prender_y_apagar_varios_leds, "test_prender_y_apagar_varios_leds", 48);
  run_test(test_consultar_led_encendido , "test_consultar_led_encendido ", 57);
  run_test(test_consultar_led_apagado , "test_consultar_led_apagado ", 63);
  ...
  run_test(test_de_valores_limites , "test_de_valores_limites ", 86);
  run_test(test_de_parametros_erroneos , "test_de_parametros_erroneos ", 95);
  run_test(test_error_de_inicializacion , "test_error_de_inicializacion ", 105);
